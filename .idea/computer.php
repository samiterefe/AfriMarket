            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <div class="box">
                        ...
                        <boutton class="btn btn-primary" > <a href="addproduct.php" style="color:red;">New Product</a></boutton>
                        <boutton class="btn btn-primary" > <a href="update-news.php" style="color:red;">upadate News</a></boutton>
                        <boutton class="btn btn-primary" > <a href="delete_custemer.php" style="color:red;">Mange custemer</a></boutton>
                        <boutton class="btn btn-primary" > <a href="remove_order.php" style="color:red;">delete order</a></boutton>
                        <boutton class="btn btn-primary" > <a href="admin.php" style="background-color: #000000;">Back</a></boutton>
