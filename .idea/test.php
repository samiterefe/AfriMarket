...
<head>
    ...
    <script type="text/javascript">
        //<![CDATA[
        try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:0,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok3v=1613a3a185/"},atok:"7211b45c46f785c55ac1aec6af1f5b08",petok:"db74ddcd05aecc4c3e5d09861507af0b63711637-1496474259-1800",zone:"colorlib.com",rocket:"a",apps:{}}];document.write('<script type="text/javascript" src="//ajax.cloudflare.com/cdn-cgi/nexp/dok3v=85b614c0f6/cloudflare.min.js"><'+'\/script>');}}catch(e){};
        //]]>
    </script>
    ...
    <link rel="stylesheet" href="bootstrap/css/main.min.css">
    ...
    <script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/less.js/2.2.0/less.min.js" type="text/rocketscript"></script>

    <!--Modernizr-->
    <script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js" type="text/rocketscript"></script>
</head>
<body class="  ">
...
<!--jQuery -->
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js" type="text/rocketscript"></script>
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js" type="text/rocketscript"></script>
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/datatables/1.10.4/js/jquery.dataTables.min.js" type="text/rocketscript"></script>
<script data-rocketsrc="//cdn.datatables.net/plug-ins/3cfcc339e89/integration/bootstrap/3/dataTables.bootstrap.js" type="text/rocketscript"></script>
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.18.4/js/jquery.tablesorter.min.js" type="text/rocketscript"></script>
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js" type="text/rocketscript"></script>

<!--Bootstrap -->
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.1/js/bootstrap.min.js" type="text/rocketscript"></script>

<!-- MetisMenu -->
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/metisMenu/1.1.3/metisMenu.min.js" type="text/rocketscript"></script>

<!-- Screenfull -->
<script data-rocketsrc="//cdnjs.cloudflare.com/ajax/libs/screenfull.js/2.0.0/screenfull.min.js" type="text/rocketscript"></script>

<!-- Metis core scripts -->
<script data-rocketsrc="assets/js/core.min.js" type="text/rocketscript"></script>
...
<script data-rocketsrc="assets/js/style-switcher.min.js" type="text/rocketscript"></script>
</body>